...
class CCodeGenerator extends CController {
	/**
	 *
	 * @var string the layout to be used by the generator. Defaults to
	 *      'generator'.
	 */
	...
	/**
	 *
	 * @var string the code model class. This can be either a class name (if it
	 *      can be autoloaded)
	 ...
	 * Child classes mainly need to provide the 'index' view for collecting user
	 * parameters
	 * for code generation.
	 */
	 ...
	 * This action shows up the difference between the newly generated code and
	 * the corresponding existing code.
	 */
	 ...
	 * The "views" directory under the directory containing the generator class
	 ...
	 *
	 * @param string $value
	 *        	the view path of the generator.
	 */
