...
<div class="row">
		...
		<div class="tooltip">
		Controller ID is case-sensitive. CRUD controllers are often named
		after the model class name that they are dealing with. Below are some
		examples:
		<ul>
			...
			<li><code>admin/user</code> generates <code>admin/UserController.php</code>.
				...
				generate <code>UserController</code> (and other CRUD code) within
				the module instead.</li>
		</ul>
	</div>
...
<div class="row sticky">
		...
		<div class="tooltip">This is the class that the new CRUD controller
		class will extend from. Please make sure the class exists and can be
		autoloaded.</div>
