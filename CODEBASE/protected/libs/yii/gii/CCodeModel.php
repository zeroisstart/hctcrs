 ...
 * from this class.
 * The purpose of a code model is to represent user-supplied parameters and use
 * them to
 * generate customized code.
 *
 * Derived classes should implement the {@link prepare} method whose main task
 * is to
 * fill up the {@link files} property based on the user parameters.
 *
 * The {@link files} property should be filled with a set of {@link CCodeFile}
 * instances,
 ...
 * is an attribute
 * that can remember its last valid value, even if the user closes his browser
 * window
 * and reopen it. To declare an attribute is sticky, simply list it in a
 * validation rule with
 * the validator name being "sticky".
 *
 * @property array $templates A list of available code templates
 *           (name=>directory).
 * @property string $templatePath The directory that contains the template
 *           files.
 * @property string $stickyFile The file path that stores the sticky attribute
 *           values.
 *          
 * @author Qiang Xue <qiang.xue@gmail.com>
...
abstract class CCodeModel extends CFormModel {
	...
	/**
	 *
	 * @var array user confirmations on whether to overwrite existing code files
	 *      with the newly generated ones.
	 *      The value of this property is internally managed by this class and
	 *      {@link CCodeGenerator}.
	 */
	public $answers;
	/**
	...
	/**
	 *
	 * @var array a list of {@link CCodeFile} objects that represent the code
	 *      files to be generated.
	 *      The {@link prepare()} method is responsible to populate this
	 *      property.
	 */
	public $files = array ();
	/**
	 ...
	 *      The value of this property is internally managed by {@link
	 *      CCodeGenerator}.
	 */
	 ...
	 * This is the main method that child classes should implement. It should
	 * contain the logic
	 * that populates the {@link files} property with a list of code files to be
	 * generated.
	 */
	 ...
	 * and the template contains all required template files as specified in
	 * {@link requiredTemplates}.
	 * 
	 ...
	 * 
	 * @return array list of code templates that are required. They should be
	 *         file paths
	...
	/**
	 * Returns the message to be displayed when the newly generated code is
	 * saved successfully.
	 * Child classes should override this method if the message needs to be
	 * customized.
	 * 
	 * @return string the message to be displayed when the newly generated code
	...
	/**
	 * Returns the message to be displayed when some error occurred during code
	 * file saving.
	 * Child classes should override this method if the message needs to be
	 * customized.
	 * 
	 * @return string the message to be displayed when some error occurred
	 *         during code file saving.
	 */
	 ...
	 * This method simply returns the {@link CCodeGenerator::templates} property
	 * value.
	 * 
	 ...
	 *         @throw CException if {@link templates} is empty or template
	...
	/**
	 *
	 * @param CCodeFile $file
	 *        	whether the code file should be saved
	 */
	 ...
	 *        	a set of parameters to be extracted and made available in the
	 *        	code template
	 ...
	 * case.
	 * This method is provided because lcfirst() PHP function is only available
	 * for PHP 5.3+.
	 * 
	 * @param string $name
	 *        	the class name
	...
	/**
	 * Validates an attribute to make sure it is not taking a PHP reserved
	 * keyword.
	 * 
	 * @param string $attribute
	 *        	the attribute to be validated
